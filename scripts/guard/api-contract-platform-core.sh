#!/usr/bin/env bash
# Offline JSON contract validator — no network, no secrets required.
# Named *contract* because it only validates the shape of platform-core-contract.json.
# The live HTTP probe lives in api-preflight-platform-core.sh.
set -euo pipefail
