...
export class CoreTables1756400000000 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ...
            CREATE INDEX idx_allocations_org_user_dates ON resource_allocations(organization_id, user_id, start_date, end_date);
            CREATE INDEX idx_allocations_project ON resource_allocations(project_id);
        `);

        // User daily capacity table (denormalized for performance)
        await queryRunner.query(`
