        ...
        return await this.dataSource.transaction(
          async (manager: EntityManager) => {
            try {
              ...
              const template = await this.createWorkflowTemplateWithRetry(
                dto,
                manager,
                context,
              );
              ...
              const stages = await this.createWorkflowStagesWithDependencies(
                dto.stages,
                template.id,
                manager,
                context,
              ...
              const approvals =
                await this.createWorkflowApprovalsWithEscalation(
                  dto.approvals || [],
                  template.id,
                  manager,
                  context,
              ...
              await this.validateCompleteWorkflowStructure(
                template.id,
                stages,
                approvals,
                manager,
              ...
              await this.emitWorkflowCreationEvents(
                template,
                stages,
                approvals,
                context,
              ...
              this.logger.log(
                `Complex workflow created successfully: ${template.id}`,
                {
              ...
              this.logger.error(
                `Failed to create complex workflow: ${error.message}`,
                {
                  error: error.stack,
                  dto,
                  context,
