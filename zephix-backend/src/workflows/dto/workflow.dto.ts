...
import { StageType, StageStatus } from '../entities/workflow-stage.entity';
import {
  ApprovalType,
  ApprovalStatus,
  ApprovalLevel,
} from '../entities/workflow-approval.entity';
import { ApprovalRuleDto } from './approval-rule.dto';
...
export class CreateWorkflowStageDto {
  ...
  @ApiPropertyOptional({
    description: 'Approval rules for this stage',
