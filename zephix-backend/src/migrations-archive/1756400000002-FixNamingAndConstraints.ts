...
export class FixNamingAndConstraints1756400000002
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_allocations_resource_dates"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "resource_allocations" DROP COLUMN IF EXISTS "workItemId"`,
    );
    await queryRunner.query(
