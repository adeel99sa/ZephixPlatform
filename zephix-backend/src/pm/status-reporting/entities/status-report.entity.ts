...
export class StatusReport {
  ...
  @Column('date', { name: 'reporting_period_start' })
  ...
  @Column('decimal', { precision: 5, scale: 2, name: 'overall_health_score' })
  overallHealthScore: number;

  @Column('varchar', { name: 'stakeholder_audience' })
  ...
  @Column('int', { name: 'critical_risks', nullable: true })
  ...
  @Column('decimal', { precision: 5, scale: 2, name: 'schedule_performance' })
  schedulePerformance: number;

  @Column('decimal', { precision: 5, scale: 2, name: 'budget_performance' })
  budgetPerformance: number;

  @Column('decimal', { precision: 5, scale: 2, name: 'scope_performance' })
  scopePerformance: number;

  @Column('decimal', { precision: 5, scale: 2, name: 'quality_performance' })
  qualityPerformance: number;

  @Column('decimal', { precision: 5, scale: 2, name: 'resource_performance' })
  ...
  @Column('decimal', { precision: 5, scale: 2, name: 'team_satisfaction' })
