...
import { AssignProgramToProjectDto } from '../programs/dto/assign-program-to-project.dto';
import { UnassignProgramFromProjectDto } from '../programs/dto/unassign-program-from-project.dto';
...
export class ProgramsController {
  ...
  @ApiQuery({ name: 'portfolioId', description: 'Filter by portfolio ID', required: false, type: String })
