...
export class CreateAuditAndIndexes1757227595841 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      CREATE INDEX IF NOT EXISTS idx_audit_org_entity ON audit_logs(organization_id, entity_type);
    ...
    // 4. Add indexes to resource_allocations (only if columns exist)
    await queryRunner.query(`
      DO $$ BEGIN
        IF EXISTS (
          ...
          EXECUTE 'CREATE INDEX IF NOT EXISTS idx_allocations_resource_date
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        IF EXISTS (
          ...
          EXECUTE 'CREATE INDEX IF NOT EXISTS idx_allocations_org
