...
export class CreateAllMissingTables1756309334132 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_users_reset_token"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_users_verification_token"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_users_email_verified"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_ROLE_NAME"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."idx_waitlist_email"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."idx_waitlist_status"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."idx_waitlist_created"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_2221cffeeb64bff14201bd5b3d"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_2221cffeeb64bff14201bd5b3d"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_PROJECT_ORGANIZATION"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_PROJECT_STATUS"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_PROJECT_PRIORITY"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_PROJECT_MANAGER"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_PROJECT_CREATED_BY"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_ROLE_NAME"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_ORGANIZATION_SLUG"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_ORGANIZATION_STATUS"`);
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_FEEDBACK_TYPE"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_FEEDBACK_STATUS"`);
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_EMAIL_VERIFICATION_TOKEN"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_EMAIL_VERIFICATION_USER"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_EMAIL_VERIFICATION_EXPIRES"`);
        await queryRunner.query(`DROP TABLE "email_verifications"`);
        await queryRunner.query(`DROP TYPE "public"."email_verifications_status_enum"`);
        await queryRunner.query(`DROP TABLE "teams"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_TEAM_MEMBER_UNIQUE"`);
        await queryRunner.query(`DROP TABLE "team_members"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_USER_ORG_USER_ID"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_USER_ORG_ORG_ID"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_USER_ORG_ACTIVE"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_USER_ORG_ROLE"`);
