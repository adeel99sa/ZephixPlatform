...
export class AddStoryToWorkTasksTypeEnum18000000000189 implements MigrationInterface {
  name = 'AddStoryToWorkTasksTypeEnum18000000000189';

  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TYPE work_tasks_type_enum ADD VALUE IF NOT EXISTS 'STORY'`,
    );
  }
