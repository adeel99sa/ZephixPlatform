...
export class AddLastLoginToUser1755931653070 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "lastLoginAt" TIMESTAMP`);
        await queryRunner.query(`UPDATE "users" SET "role" = 'admin' WHERE "email" = 'admin@zephix.ai'`);
    }
