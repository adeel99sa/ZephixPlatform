...
const AppDataSource = new DataSource({
  ...
  synchronize: false, // Don't auto-sync everything
  logging: true,
  entities: ['src/pm/risk-management/entities/*.ts'], // Only risk entities
});
...
async function createRiskTables() {
  try {
    ...
    // Create risk management tables manually
