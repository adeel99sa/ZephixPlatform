...
export const HowItWorksSection: React.FC = () => {
  ...
  return (
    <section id="how-it-works" className="bg-gray-50 py-16" aria-labelledby="how-it-works-heading">
      <div className="container mx-auto px-4 text-center">
        <h2 id="how-it-works-heading" className="text-3xl font-bold tracking-tight text-gray-800 mb-3">
          How Zephix Works
        </h2>
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {steps.map((step, i) => (
            <div key={step} className="space-y-4" role="article" aria-labelledby={`step-${i + 1}`}>
              ...
              <h3 id={`step-${i + 1}`} className="text-xl font-bold tracking-tight">{step}</h3>
