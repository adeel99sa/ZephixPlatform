...
import { ProjectOverviewTab, ProjectPlanTab, ProjectTasksTab, ProjectBoardTab, ProjectGanttTab, ProjectSprintsTab, ProjectRisksTab, ProjectResourcesTab } from "@/features/projects/tabs";
